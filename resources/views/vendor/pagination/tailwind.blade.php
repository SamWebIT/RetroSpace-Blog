                ...
                <span class="relative z-0 inline-flex rounded-md">
                    ...
                    @if (!$paginator->onFirstPage())
                        <a href="{{ $paginator->previousPageUrl() }}" rel="next"
                            class="h-10 w-10 font-semibold text-gray-800 hover:text-blue-600 text-sm flex items-center justify-center mr-3"
                    ...
                    @if ($paginator->hasMorePages())
                        <a href="{{ $paginator->nextPageUrl() }}" rel="next"
                            class="h-10 w-10 font-semibold text-gray-800 hover:text-blue-600 text-sm flex items-center justify-center ml-3"
                            aria-label="{{ __('pagination.next') }}">
