<div class="flex justify-between mb-4 gap-3">
    ...
    <div class="flex-1">
        ...
        @endif
        <div>
            <button wire:click.prevent="startReply" class="text-sm text-indigo-600 mr-3">Reply</button>
            @if (\Illuminate\Support\Facades\Auth::id() == $comment->user_id)
                <button wire:click.prevent="startCommentEdit" class="text-sm text-blue-600 mr-3">Edit</button>
                <button wire:click.prevent="deleteComment" onclick="return confirm('Are you sure to delete this comment ?')" class="text-sm text-red-600">Delete</button>
            @endif
        </div>
